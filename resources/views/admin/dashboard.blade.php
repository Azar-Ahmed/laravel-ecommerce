                                            ...
                                            <div class="media">
                                                <div class="media-image mr-3 rounded-circle">
                                                    <a href="profile.html"><img
                                                            ...
                                                            src="{{asset('admin_assets/img/user/u1.jpg')}}"
                                        ...
                                        <td>
                                            <div class="media">
                                                <div class="media-image mr-3 rounded-circle">
                                                    <a href="profile.html"><img
                                                            class="profile-img rounded-circle w-45"
                                                            src="{{asset('admin_assets/img/user/u2.jpg')}}"
                                                            alt="customer image"></a>
                                                </div>
                                                <div class="media-body align-self-center">
                                                    <a href="profile.html">
                                        ...
                                        <td>
                                            <div class="media">
                                                <div class="media-image mr-3 rounded-circle">
                                                    <a href="profile.html"><img
                                                            class="profile-img rounded-circle w-45"
                                                            src="{{asset('admin_assets/img/user/u3.jpg')}}"
                                                            alt="customer image"></a>
                                                </div>
                                                <div class="media-body align-self-center">
                                                    <a href="profile.html">
                                        ...
                                        <td>
                                            <div class="media">
                                                <div class="media-image mr-3 rounded-circle">
                                                    <a href="profile.html"><img
                                                            class="profile-img rounded-circle w-45"
                                                            src="{{asset('admin_assets/img/user/u4.jpg')}}"
                                                            alt="customer image"></a>
                                                </div>
                                                <div class="media-body align-self-center">
                                                    <a href="profile.html">
                                        ...
                                        <td>
                                            <div class="media">
                                                <div class="media-image mr-3 rounded-circle">
                                                    <a href="profile.html"><img
                                                            class="profile-img rounded-circle w-45"
                                                            src="{{asset('admin_assets/img/user/u5.jpg')}}"
                                                            alt="customer image"></a>
                                                </div>
                                                <div class="media-body align-self-center">
                                                    <a href="profile.html">
                        ...
                        <div class="card-body mt-10px mb-10px py-0">
                            <div class="row media d-flex pt-15px pb-15px">
                                <div
                                    ...
                                    <a href="#"><img src="{{asset('admin_assets/img/products/p1.jpg')}}" alt="customer image"></a>
                                </div>
                            ...
                            <div class="row media d-flex pt-15px pb-15px">
                                <div
                                    class="col-lg-3 col-md-3 col-2 media-image align-self-center rounded">
                                    <a href="#"><img src="{{asset('admin_assets/img/products/p2.jpg')}}" alt="customer image"></a>
                                </div>
                                <div class="col-lg-9 col-md-9 col-10 media-body align-self-center ec-pos">
                                    <a href="#">
                            ...
                            <div class="row media d-flex pt-15px pb-15px">
                                <div
                                    class="col-lg-3 col-md-3 col-2 media-image align-self-center rounded">
                                    <a href="#"><img src="{{asset('admin_assets/img/products/p3.jpg')}}" alt="customer image"></a>
                                </div>
                                <div class="col-lg-9 col-md-9 col-10 media-body align-self-center ec-pos">
                                    <a href="#">
