...
@section('page_title', 'Dashboard - Size Form')
    @section('container')
    <div class="ec-content-wrapper">
        <div class="content">
            <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
                ...
                <div>
                    <a href="{{url('admin/size')}}" class="btn btn-primary"> View All
                    </a>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            <form action="{{ url('size/save') }}" method="POST" enctype="multipart/form-data" autocomplete="off"> 
                                @csrf
