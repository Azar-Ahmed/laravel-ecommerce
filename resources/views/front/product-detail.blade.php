...
@section('page_title', 'Ecommerce App - Product Detail')
    @section('container')
                                    ...
                                    <div class="single-product-scroll">
                                        <div class="single-product-cover">
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="{{asset('uploads/product/'.$product->cover_image)}}"
                                                    alt="">
                                            </div>
                                            {{-- <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="{{asset('front_assets/images/product-360/1_2.jpg')}}"
                                                    alt="">
                                            </div>
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="{{asset('front_assets/images/product-360/1_3.jpg')}}"
                                                    alt="">
                                            </div>
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="{{asset('front_assets/images/product-360/1_4.jpg')}}"
                                                    alt="">
                                            </div>
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="{{asset('front_assets/images/product-360/1_5.jpg')}}"
                                                    alt="">
                                            </div> --}}
                                        </div>
                                        <div class="single-nav-thumb">
                                            @foreach ($product_multiple_img as $multiple_img)
                                                <div class="single-slide">
                                                    <img class="img-responsive" src="{{asset('uploads/product/multiple_img/'.$multiple_img->image_url)}}" alt="">
                                                </div>
                                            @endforeach
                                        </div>
                                    </div>
                                        ...
                                        <div class="ec-t-review-wrapper">
                                            <div class="ec-t-review-item">
                                                <div class="ec-t-review-avtar">
                                                    <img src="{{asset('front_assets/images/review-image/1.jpg')}}" alt="" />
                                                </div>
                                            ...
                                            <div class="ec-t-review-item">
                                                <div class="ec-t-review-avtar">
                                                    <img src="{{asset('front_assets/images/review-image/2.jpg')}}" alt="" />
                                                </div>
                                                <div class="ec-t-review-content">
                                                    <div class="ec-t-review-top">
                            ...
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.html" class="image">
                                    <img class="main-image"
                                        src="{{asset('front_assets/images/product-image/6_1.jpg')}}" alt="Product" />
                                    <img class="hover-image"
                                        src="{{asset('front_assets/images/product-image/6_2.jpg')}}" alt="Product" />
                                </a>
                    ...
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.html" class="image">
                                    <img class="main-image"
                                        src="{{asset('front_assets/images/product-image/7_1.jpg')}}" alt="Product" />
                                    <img class="hover-image"
                                        src="{{asset('front_assets/images/product-image/7_2.jpg')}}" alt="Product" />
                                </a>
                                <span class="percentage">20%</span>
                                <span class="flags">
                    ...
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.html" class="image">
                                    <img class="main-image"
                                        src="{{asset('front_assets/images/product-image/1_1.jpg')}}" alt="Product" />
                                    <img class="hover-image"
                                        src="{{asset('front_assets/images/product-image/1_2.jpg')}}" alt="Product" />
                                </a>
                                <span class="percentage">20%</span>
                                <span class="flags">
                                    <span class="sale">Sale</span>
                    ...
                    <div class="ec-product-inner">
                        <div class="ec-pro-image-outer">
                            <div class="ec-pro-image">
                                <a href="product-left-sidebar.html" class="image">
                                    <img class="main-image"
                                        src="{{asset('front_assets/images/product-image/2_1.jpg')}}" alt="Product" />
                                    <img class="hover-image"
                                        src="{{asset('front_assets/images/product-image/2_2.jpg')}}" alt="Product" />
                                </a>
                                <span class="percentage">20%</span>
                                <span class="flags">
