 ...
 <body>
               ...
               <ul class="eccart-pro-items">
                   <li>
                       <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                               src="{{asset('front_assets/images/product-image/6_1.jpg')}}" alt="product"></a>
                   ...
                   <li>
                       <a href="product-left-sidebar.html" class="sidekka_pro_img"><img
                               src="{{asset('front_assets/images/product-image/12_1.jpg')}}" alt="product"></a>
                       <div class="ec-pro-content">
   ...
   <!-- ekka Cart End -->
    ...
    @yield('container')
                         ...
                         <a class="ec-list" data-number="918866774266"
                             ...
                             <div class="d-flex bd-highlight">
                                 ...
                                 <div class="ec-img-cont">
                                     <img src="{{asset('front_assets/images/whatsapp/profile_01.jpg')}}" class="ec-user-img"
                                         alt="Profile image">
                     ...
                     <li>
                         <a class="ec-list" data-number="918866774266"
                             ...
                             <div class="d-flex bd-highlight">
                                 <!-- Profile Picture -->
                                 <div class="ec-img-cont">
                                     <img src="{{asset('front_assets/images/whatsapp/profile_02.jpg')}}" class="ec-user-img"
                                         alt="Profile image">
                     ...
                     <li>
                         <a class="ec-list" data-number="918866774266"
                             ...
                             <div class="d-flex bd-highlight">
                                 <!-- Profile Picture -->
                                 <div class="ec-img-cont">
                                     <img src="{{asset('front_assets/images/whatsapp/profile_03.jpg')}}" class="ec-user-img"
                                         alt="Profile image">
                     ...
                     <li>
                         <a class="ec-list" data-number="918866774266"
                             ...
                             <div class="d-flex bd-highlight">
                                 <!-- Profile Picture -->
                                 <div class="ec-img-cont">
                                     <img src="{{asset('front_assets/images/whatsapp/profile_04.jpg')}}" class="ec-user-img"
                                         alt="Profile image">
                                     <span class="ec-status-icon ec-offline"></span>
                                 </div>
                                 <!-- Display Name & Last Seen -->
     ...
     <!-- Feature tools color change settings -->
