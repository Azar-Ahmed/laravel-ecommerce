...
@section('page_title', 'Ecommerce App - Shop')
    @section('container')
          <!-- Ec breadcrumb start -->
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-6 mb-6 pro-gl-content">
                                        <div class="ec-product-inner">
                                                ...
                                                <div class="ec-pro-image">
                                                    <a href="product-left-sidebar.html" class="image">
                                                        <img class="main-image"
                                                            src="{{asset('uploads/product/'.$product->cover_image)}}" alt="Product" />
                                            ...
                                            <div class="ec-pro-content">
                                                <h5 class="ec-pro-title"><a href="{{url('product-detail/'.$product->id)}}">{{$product->product_name}}</a></h5>
                                                    ...
                                                    <div class="ec-pro-color">
                                                        ...
                                                        <ul class="ec-opt-swatch ec-change-img">
                                                            <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                    data-src="{{asset('uploads/product/'.$product->cover_image)}}"
                                                                    data-src-hover="{{asset('uploads/product/'.$product->cover_image)}}"
